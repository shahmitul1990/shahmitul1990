<p align="center">
  <img 
    src="https://github.com/user-attachments/assets/76639ba5-5437-4862-9a60-63ea318d9083"
    alt="image"
    width="300"
    height="auto"
  />
...
I love transforming data into insights, building ML systems, and solving real business problems end-to-end.

---

## 🚀 About Me

- 🔍 Strong interest in **ML Modeling** and **Data Storytelling**  
- 📊 Passionate about **Experiment Design (A/B, A/A Testing)** & **Statistical Modeling**  
- 💼 Experience working across machine learning, analytics, and business problem solving  
- 🎯 Currently improving my skills in **Time-series forecasting** and **ML deployment**  
- 🤝 Open to collaborations in Data Science & ML
...
![KNN](https://img.shields.io/badge/k--NN-20B2AA?style=for-the-badge)
![Naive Bayes](https://img.shields.io/badge/Naive_Bayes-DAA520?style=for-the-badge)
![AdaBoost](https://img.shields.io/badge/AdaBoost-FF4500?style=for-the-badge)
![Neural Networks](https://img.shields.io/badge/Neural_Networks-9400D3?style=for-the-badge)
![PCA](https://img.shields.io/badge/PCA-6495ED?style=for-the-badge)
![Clustering](https://img.shields.io/badge/Clustering-2E8B57?style=for-the-badge)
...
🔗 Repo: *(Pinned in profile)*

---

### 🔹 **2. A/B Test Bias Detection — Experimentation**
Finding out whether the A/B test is conducted in a proper manner.  
**Tech:** R, A/B testing, preprocessing  
🔗 Repo: *(Pinned in profile)*

---

### 🔹 **3. Other ML/Analytics Projects**
Check my repositories for:  
- Regression models  
- Classification models  
- Experimentation-focused notebooks  
